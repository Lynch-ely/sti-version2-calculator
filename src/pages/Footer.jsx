    ...
    return(
        <section id="footer" className="py-5 flex text-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex lg:flex-row gap-2 items-center justify-center">
                <h1 className="relative pb-1 font-medium text-xs sm:text-sm uppercase tracking-wider">Developed By: </h1>
                <a href="https://www.facebook.com/enson.ely" 
                target="_blank" 
                rel="noreferrer" 
                className="relative pb-1 font-medium text-xs sm:text-sm uppercase tracking-wider
